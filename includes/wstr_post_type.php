...
class wstr_post_types
{
    ...
    public function register_domain_post_type()
    {
        ...
        $args = array(
            ...
            'hierarchical' => false,
            'menu_position' => null,
            'supports' => array('title', 'editor', 'author', 'thumbnail', 'status'),
            'show_in_rest' => true,
        );
    ...
    public function add_taxonomy_image_field($taxonomy)
    {
        ...
        <div class="form-field term-group">
            ...
            <p>
                <input type="button" class="button button-secondary" id="taxonomy-image-upload-button"
                    value="<?php _e('Add Image', 'webstarter'); ?>">
                <input type="button" class="button button-secondary" id="taxonomy-image-remove-button"
                    value="<?php _e('Remove Image', 'webstarter'); ?>">
            </p>
        </div>
        <?php
    }
