...
class Wstr_admin_menu
{
    ...
    {
        add_action('admin_menu', array($this, 'wstr_multi_currency_menu'));
    }

    /** Step 1. */
    function wstr_multi_currency_menu()
    {
        add_menu_page('Multi Currency', 'Multi Currency', 'manage_options', 'wstr-multi-currency', array($this, 'wstr_multi_currency_options'));
    }

    /** Step 3. */
    function wstr_multi_currency_options()
    {
